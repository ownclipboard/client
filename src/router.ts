...
const routes: Array<RouteRecordRaw> = [
...

  {
    ...
    children: [
      ...
      { path: "files", name: "files", component: () => import("./views/Files.vue"), meta: { title: "Files" } },
      { path: "devices", name: "devices", component: () => import("./views/Devices.vue"), meta: { title: "Devices" } },
